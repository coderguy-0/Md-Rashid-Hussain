...
export default function App() {
  ...
  // Handle new registration success - transition to Professional Dashboard
  const handleRegisterSuccess = (newDoc: DoctorProfile) => {
    setDoctors((prev) => [newDoc, ...prev]);
    setVerifiedDoctor(newDoc);
  };
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans flex flex-col selection:bg-emerald-500 selection:text-white">
      {/* Top Navbar */}
      <Navbar verifiedCount={verifiedCount} />
